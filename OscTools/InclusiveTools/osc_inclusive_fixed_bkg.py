...
from .inclusive_osc_tools import muB_NoBkgOsc_Chi2


MiniBooNE_Signal_PANM = np.loadtxt(
    f"{osc.__annotations__mb_data_osctables}/dm-sin-MB-events-table-less-points.dat"
)
Result = []
Pairs = []
...
np.savetxt(f"{osc.path_osc_data}/Inclusive_NoBkgOsc_Chi2.dat", Result)
