...
MiniBooNE_Signal_PANM_True = np.loadtxt(
    f"{osc.mb_data_osctables}/dm-MB-events-table-TrueEnu.dat"
)
MB_True_Bins = [
    0.200,
    0.250,
...
np.save(
    f"{osc.path_osc_data}/Dm41_SSq2ME_SSq2MM_PVs",
...
if __name__ == "__main__":
    ...
    np.save(f"{osc.path_osc_data}/FullAnalysis_AppDis_SSq2ME_SSq2MM", res)
