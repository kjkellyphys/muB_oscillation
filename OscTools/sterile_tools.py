...
class Sterile:
    def __init__(
        ...
        self.pathdata = "OscTools/include/miniboone_eff/eg_effs.dat"
    ...
    def PmeoscAvg(self, Emin, Emax, Length):
        # safely avoid 0.0 energy
        Emin += 0.000001

        # osc term in Pee, does not involve energy degradation
        return self.Um4Sq * self.Ue4Sq * self.FoscAvg_analytical(Emin, Emax, Length)
